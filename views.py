...
def index(page=1):
	posts = Thread.query.from_self().paginate(page, 3, False)
...
def post(page=1):
	...
	if form.validate_on_submit():
		...
		if form.image.has_file():
			...
			form.image.data.save('app/images/' + filename)
		else:
			filename = None
		...
		thread = Thread(popularity=1, subject=form.subject.data, name=username, image=url_for('images', filename=filename), body=form.body.data, 
